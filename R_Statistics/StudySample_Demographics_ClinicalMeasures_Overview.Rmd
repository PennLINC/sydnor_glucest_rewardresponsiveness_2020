...
```{r, echo=F}
#Table 1 inputs
Demotable <- data.frame(Variable=character(),Study_Sample=double(), Typically_Developing=double(), Clinical=double(), Pvalue=double())
Demotable <- Demotable %>% add_row(Variable = "Age", Study_Sample= 22.7, Typically_Developing= 22.6, Clinical= 22.9, Pvalue="n.s.")
