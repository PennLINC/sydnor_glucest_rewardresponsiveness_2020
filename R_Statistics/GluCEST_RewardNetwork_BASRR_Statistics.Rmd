...
knitr::opts_knit$set(root.dir = "/Users/valeriejill/Documents/ResearchProjects/GluCEST_BASRewardResponsivity_Project/OutputMeasures/")
...
```{r echo=TRUE}
plotdata <- data.frame(glucest$BAS_Reward_totalscore, GluCEST_RewardNetwork$RewardNetwork_CEST_mean)

jpeg("/Users/valeriejill/Documents/ResearchProjects/GluCEST_BASRewardResponsivity_Project/Figures/Images/BASRR_RewardNetworkTotal_CorrelationPlot.jpg", units="in", width=7.3, height=6.6, res=800)

ggplot(plotdata, aes(x=glucest.BAS_Reward_totalscore, y=GluCEST_RewardNetwork.RewardNetwork_CEST_mean)) + 
  geom_point(color="black", fill=alpha(c("#860000"),.99), shape=21, size=3) +
...
```{r}
summary(aov(GluCEST_RewardNetwork$RewardNetwork_CEST_mean ~ as.factor(glucest$Control_Coded) + glucest$age + glucest$sex))
```
...
```{r}
plotdata <- data.frame(glucest$BAS_Reward_totalscore, GluCEST_RewardNetwork_Subcortical$RewardNetwork_Subcortical_CEST_mean)
color <- c("#ffdb3c")
decimalscale <- function(x) sprintf("%.1f", x)

jpeg("/Users/valeriejill/Documents/ResearchProjects/GluCEST_BASRewardResponsivity_Project/Figures/Images/BASRR_RewardNetworkSubcortical_CorrelationPlot.jpg", units="in", width=7.3, height=6.6, res=800)


ggplot(plotdata, aes(x=glucest.BAS_Reward_totalscore, y=GluCEST_RewardNetwork_Subcortical.RewardNetwork_Subcortical_CEST_mean)) +
 geom_point(color="black", fill=alpha(color,.99), shape=21, size=3) +
  labs(x="\nBAS Reward Responsiveness Score\n", y="\nGluCEST % Contrast\n") +
  ggtitle("\n") +
  theme(
  axis.title.x=element_text(family="Arial", vjust=0.5, size=17),
...
**PRIME Scores**
```{r}
#linear regression between GluCEST and PRIME scores controlling for BAS Reward Responsivity, age, and sex
...
**PROMIS Scores**
```{r}
#linear regression between GluCEST and PROMIS scores controlling for BAS Reward Responsivity, age, and sex
...
**BAS Drive Scores**
```{r}
#linear regression between GluCEST and BAS Drive scores controlling for BAS Reward Responsivity, age, and sex
...
**BAS Fun Scores**
```{r}
#linear regression between GluCEST and BAS Fun scores controlling for BAS Reward Responsivity, age, and sex
